...
struct QuestionAndAnswer2 {
    var question: String
    var answer: [String]
    var currectAnswer: Int
}

class MeduimLevalViewController: UIViewController {
    
    @IBOutlet weak var questionLable: UILabel!
    @IBOutlet weak var scoreLable: UILabel!
    @IBOutlet weak var wrongButton: UIButton!
    @IBOutlet weak var yesButton: UIButton!
    @IBOutlet weak var MeduimLevalProgressBar: UIProgressView!
...
//            MeduimLevalProgressBar.setProgress(Float(timerCount)/11, animated: true)
//        } else {
//            timer.invalidate()
//        }
//
...
//    }
    ...
    private func configureTimer(){
        ...
        MeduimLevalProgressBar.setProgress(1, animated: true)
    }
